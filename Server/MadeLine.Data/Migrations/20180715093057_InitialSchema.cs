        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PictureUrl = table.Column<string>(maxLength: 2100, nullable: true),
                    IsDeleted = table.Column<bool>(nullable: false),
                    DeletedOn = table.Column<DateTime>(nullable: true),
                    RegisterIP = table.Column<string>(maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuidName = table.Column<string>(maxLength: 127, nullable: false),
                    Extension = table.Column<string>(maxLength: 127, nullable: true),
                    MimeType = table.Column<string>(maxLength: 127, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    UniqueKey = table.Column<string>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressLine1 = table.Column<string>(maxLength: 1000, nullable: false),
                    AddressLine2 = table.Column<string>(maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Campaigns_Images_ThumbnailId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmbededVideo = table.Column<string>(nullable: false),
                    Created = table.Column<DateTime>(nullable: false),
                    Modified = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vlogs_Images_ThumbnailId",
                        column: x => x.ThumbnailId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(maxLength: 50, nullable: false),
                    Alias = table.Column<string>(maxLength: 50, nullable: false),
                    SKUCode = table.Column<string>(maxLength: 10, nullable: false),
                    BrandId = table.Column<int>(nullable: false),
                    IsHighlighted = table.Column<bool>(nullable: false),
                    MainImageId = table.Column<int>(nullable: false),
                    HighlightImageId = table.Column<int>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_Images_HighlightImageId",
                        column: x => x.HighlightImageId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(maxLength: 100, nullable: false),
                    Language = table.Column<int>(nullable: false),
                    VlogId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VlogTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VlogTranslations_Vlogs_VlogId",
                        column: x => x.VlogId,
                        principalTable: "Vlogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderStatuses_Orders_OrderId1",
                        column: x => x.OrderId1,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductSKU = table.Column<string>(maxLength: 10, nullable: false),
                    ProductPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ProductDiscountValue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ProductDiscountPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ProductFinalPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatuses_OrderId1",
                table: "OrderStatuses",
                column: "OrderId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_HighlightImageId",
                table: "Products",
                column: "HighlightImageId");

            migrationBuilder.CreateIndex(
                name: "IX_Products_IsHighlighted",
                table: "Products",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vlogs_ThumbnailId",
                table: "Vlogs",
                column: "ThumbnailId");

            migrationBuilder.CreateIndex(
                name: "IX_VlogTranslations_VlogId",
                table: "VlogTranslations",
                column: "VlogId");
        }
